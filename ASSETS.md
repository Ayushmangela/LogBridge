...
| `tilesets/agentroom/FloorAndGround.png` | 64 × 40 | **All floors.** 4 column groups of 3 (cols 1–3, 5–7, 9–11, 13–15), ~18 styles each in row pairs. Currently: **cols 5–7 rows 36–37** (light grey) for every room, **rows 32–33** (speckled grey) for the cafeteria |
